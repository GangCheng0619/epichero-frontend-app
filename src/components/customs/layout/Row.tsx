...
// type
import { LayoutRowProps, ResponsivedLayoutRowProps } from "types/components/Layout";
...
const getResponsive = (responsive: { [x: string]: any;[x: number]: LayoutRowProps; }, flexDirection: string | undefined, display: string | undefined, gap: string | number | undefined) => {
  let resStyle = "";
...
// func getter for gap
const getGap = (flexDirection: string | undefined, gap: string | number | undefined, display: string | undefined) => {
  if (display === "grid") {
    return `
     gap: ${gap}px;
    `;
